...
urlpatterns = [
    ...
    path('student_ede/<int:pk>/pdf_to_expert', views.print_pdf_to_expert_ede, name='print-pdf-to-expert-ede'),
    path('student/<int:pk>/examination_compensation', views.print_examination_compensation_form, name='examination_compensation'),
