...
class SendConvocationView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        form = ConvocationForm(initial={
            ...
            'message': loader.render_to_string('email/candidate_convocation_EDE.txt', data),
    ...
    def form_valid(self, form):
        ...
        candidate = Candidate.objects.get(pk=form.cleaned_data['id_candidate'])
        candidate.convocation_sended_email=datetime.now()
        candidate.save()
